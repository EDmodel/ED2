function plot_fluxes(flux_tp,flux_cp,flux_td,flux_cd,flux_tm,flux_cm,varnames,varunits...
...
set(gcf,'PaperPositionMode','manual','Units','inches','Position',[0.25 0.25 10.5 6]);
