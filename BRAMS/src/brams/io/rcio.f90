...
subroutine commio (cfile,io,iun)
   ...
   use grell_coms, only : grell_nclouds => nclouds &
                         ,iupmethod,iupstrm,radius,depth_min,cap_maxs &
   ...
   ie=cio_i_sca(iun,irw,'grell_nclouds',grell_nclouds,1)
   ...
   ie=cio_f(iun,irw,'confrq',confrq,grell_nclouds)
   ie=cio_i_sca(iun,irw,'iupmethod',iupmethod,1)
   ie=cio_i_sca(iun,irw,'iupstrm',iupstrm,1)
   ie=cio_f(iun,irw,'radius',radius,grell_nclouds)
   ie=cio_f(iun,irw,'depth_min',depth_min,grell_nclouds)
   ie=cio_f(iun,irw,'cap_maxs',cap_maxs,grell_nclouds)
   ie=cio_f(iun,irw,'zkbmax',zkbmax,grell_nclouds)
   ie=cio_f(iun,irw,'zcutdown',zcutdown,grell_nclouds)
   ie=cio_f(iun,irw,'z_detr',z_detr,grell_nclouds)
   ie=cio_f(iun,irw,'max_heat',max_heat,grell_nclouds)
   ie=cio_c(iun,irw,'closure_type',closure_type,grell_nclouds)
