...
contains
  ...
  subroutine alloc_scratch(nmzp,nmxp,nmyp,nnzp,nnxp,nnyp  &
    ...
    call azero(ntpts_catt, scratch%scr2(1))
    if (CATT == 1) then
       call azero(ntpts_catt, scratch%scr3(1))
    else
       call azero(1, scratch%scr3(1))  ! Not used in this case
    endif

    call azero(ntpts,  scratch%vt3da(1))
    call azero(ntpts,  scratch%vt3db(1))
    call azero(ntpts1, scratch%vt3dc(1))
    call azero(ntpts1, scratch%vt3dd(1))
    call azero(ntpts1, scratch%vt3de(1))
    call azero(ntpts1, scratch%vt3df(1))
    call azero(ntpts1, scratch%vt3dg(1))
    call azero(ntpts1, scratch%vt3dh(1))
    call azero(ntpts1, scratch%vt3di(1))
    call azero(ntpts1, scratch%vt3dj(1))
    call azero(ntpts1, scratch%vt3dk(1))
    call azero(ntpts1, scratch%vt3dl(1))
    call azero(ntpts1, scratch%vt3dm(1))
    call azero(ntpts1, scratch%vt3dn(1))
    call azero(ntpts1, scratch%vt3do(1))
    call azero(ntpts1, scratch%vt3dp(1))
    call azero(ntpts1, scratch%vt3dq(1))
    call azero(ntpts2, scratch%vt2da(1))
    call azero(ntpts2, scratch%vt2db(1))
    call azero(ntpts2, scratch%vt2dc(1))
