...
subroutine grell_thermo_cldlev(mkx,mgmzp,z_cup,exner,thil,t,qtot,qliq,qice,exnersur        &
   ...
   real   , dimension(mgmzp), intent(out) :: exner_cup  ! Exner function           [J/kg/K]
   real   , dimension(mgmzp), intent(out) :: p_cup      ! Pressure                 [    Pa]
   real   , dimension(mgmzp), intent(out) :: t_cup      ! Temperature              [     K]
   real   , dimension(mgmzp), intent(out) :: thil_cup   ! Theta_il                 [     K]
   real   , dimension(mgmzp), intent(out) :: qtot_cup   ! Total mixing ratio       [ kg/kg]
   real   , dimension(mgmzp), intent(out) :: qvap_cup   ! Vapour mixing ratio      [ kg/kg]
   real   , dimension(mgmzp), intent(out) :: qliq_cup   ! Liq. water mixing ratio  [ kg/kg]
   real   , dimension(mgmzp), intent(out) :: qice_cup   ! Ice mixing ratio         [ kg/kg]
   real   , dimension(mgmzp), intent(out) :: qsat_cup   ! Sat. vapour mixing ratio [ kg/kg]
   real   , dimension(mgmzp), intent(out) :: rho_cup    ! Air density              [ kg/m³]
   real   , dimension(mgmzp), intent(out) :: theiv_cup  ! Thetae_iv                [     K]
   real   , dimension(mgmzp), intent(out) :: theivs_cup ! Sat. thetae_iv           [     K]
