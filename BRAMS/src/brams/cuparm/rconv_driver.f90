...
subroutine rconv_driver()
   ...
   if (nshallowest(ngrid) == 1 .and.                                                       &
       ...
       call cloud_sketch(mzp,mxp,myp,ia,iz,ja,jz,dtlt                                      &
         ...
         , cuparm_g(ngrid)%conprr   (1,1,nclouds) , cuparm_g(ngrid)%cupcond(1,1,1,nclouds) )
   end if
   ...
   if (ndeepest(ngrid) == 1 .and.                                                          &
       ...
       call cloud_sketch(mzp,mxp,myp,ia,iz,ja,jz,dtlt                                      &
         ...
         , cuparm_g(ngrid)%conprr         (1,1,1) , cuparm_g(ngrid)%cupcond      (1,1,1,1) )
   end if
