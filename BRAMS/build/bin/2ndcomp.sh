...
rm -fv cup_env_catt.o             cup_env_catt.mod
rm -fv cup_grell2.o               cup_grell2.mod
rm -fv cup_grell2_shcu.o          cup_grell2_shcu.mod
rm -fv cup_grell_catt_deep.o      cup_grell_catt_deep.mod
rm -fv cup_grell_catt_shallow.o   cup_grell_catt_shallow.mod
rm -fv cup_output_vars.o          cup_output_vars.mod
...
rm -fv extras_rconv_grell_catt.o  extras_rconv_grell_catt.mod
...
rm -fv mem_cutrans.o              mem_cutrans.mod
...
rm -fv mem_grell.o                mem_grell.mod
...
rm -fv mem_micro_optij.o          mem_micro_optij.mod
...
rm -fv mic_driv_new.o             mic_driv_new.mod
...
rm -fv rconv.o                    rconv.mod
rm -fv rconv_grell.o              rconv_grell.mod
rm -fv rconv_grell_catt.o         rconv_grell_catt.mod
...
rm -fv rstilt.o                   rstilt.mod
rm -fv rshcupar.o                 rshcupar.mod
