...
edcp_driver.o : $(ED_MIXED)/edcp_driver.f90 grid_coms.o mem_edcp.o ed_state_vars.o         \
	ed_misc_coms.o soil_coms.o ed_node_coms.o consts_coms.o ed_work_vars.o io_params.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

edcp_init.o : $(ED_MIXED)/edcp_init.f90 node_mod.o mem_grid.o rpara.o soil_coms.o          \
	mem_leaf.o soil_coms.o ed_state_vars.o ed_node_coms.o ed_para_coms.o ed_max_dims.o \
	grid_coms.o ed_work_vars.o canopy_air_coms.o consts_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

edcp_load_namelist.o : $(ED_MIXED)/edcp_load_namelist.f90 ed_max_dims.o soil_coms.o        \
	met_driver_coms.o mem_sites.o physiology_coms.o phenology_coms.o decomp_coms.o     \
	disturb_coms.o pft_coms.o ed_misc_coms.o grid_coms.o optimiz_coms.o mem_grid.o     \
	io_params.o mem_leaf.o mem_radiate.o grid_dims.o rk4_coms.o canopy_radiation_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
edcp_met.o : $(ED_MIXED)/edcp_met.f90 node_mod.o rconstants.o met_driver_coms.o            \
	...
	mem_cuparm.o mem_micro.o mem_grid.o therm_lib.o mem_edcp.o ed_misc_coms.o          \
	mem_leaf.o ed_work_vars.o mem_turb.o micphys.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

edcp_met_init.o : $(ED_MIXED)/edcp_met_init.f90 ed_misc_coms.o ed_state_vars.o soil_coms.o \
...
edcp_model.o : $(ED_MIXED)/edcp_model.f90 mem_grid.o mem_leaf.o ed_node_coms.o             \
	ed_misc_coms.o mem_edcp.o grid_coms.o ed_state_vars.o rk4_driver.o disturb_coms.o  \
	mem_sites.o consts_coms.o disturbance.o fuse_fiss_utils.o growth_balive.o          \
	node_mod.o mem_leaf.o mem_basic.o mem_radiate.o mem_cuparm.o mem_micro.o           \
	therm_lib.o consts_coms.o io_params.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

edcp_mpiutils.o : $(ED_MIXED)/edcp_mpiutils.f90 ed_max_dims.o ed_misc_coms.o grid_coms.o   \
	soil_coms.o met_driver_coms.o mem_sites.o physiology_coms.o phenology_coms.o       \
	decomp_coms.o pft_coms.o disturb_coms.o optimiz_coms.o canopy_radiation_coms.o     \
	rk4_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
edcp_water.o : $(ED_MIXED)/edcp_water.f90 node_mod.o consts_coms.o canopy_air_coms.o       \
	...
	mem_grid.o therm_lib.o met_driver_coms.o leaf_coms.o rk4_coms.o                    \
...
allometry.o : $(ED_UTILS)/allometry.f90 pft_coms.o grid_coms.o soil_coms.o consts_coms.o   \
	rk4_coms.o canopy_radiation_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

average_utils.o : $(ED_IO)/average_utils.f90 grid_coms.o ed_misc_coms.o ed_state_vars.o    \
	ed_max_dims.o canopy_radiation_coms.o consts_coms.o allometry.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
canopy_radiation_coms.o : $(ED_MEMORY)/canopy_radiation_coms.f90 ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

canopy_struct_dynamics.o : $(ED_DYNAMICS)/canopy_struct_dynamics.f90 ed_misc_coms.o         \
	ed_state_vars.o rk4_coms.o pft_coms.o canopy_air_coms.o consts_coms.o soil_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

canopy_update_euler.o : $(ED_DYNAMICS)/canopy_update_euler.f90 ed_state_vars.o grid_coms.o \
	canopy_radiation_coms.o consts_coms.o ed_max_dims.o grid_coms.o therm_lib.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
decomp_coms.o : $(ED_MEMORY)/decomp_coms.f90 ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
disturbance.o : $(ED_DYNAMICS)/disturbance.f90 ed_state_vars.o fuse_fiss_utils.o           \
	ed_misc_coms.o disturb_coms.o ed_max_dims.o pft_coms.o consts_coms.o grid_coms.o   \
	decomp_coms.o canopy_air_coms.o mem_sites.o ed_therm_lib.o allometry.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

ed_bare_restart.o : $(ED_INIT)/ed_bare_restart.f90 ed_state_vars.o ed_max_dims.o           \
	pft_coms.o consts_coms.o canopy_air_coms.o therm_lib.o allometry.o                 \
	fuse_fiss_utils.o ed_therm_lib.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

ed_driver.o : $(ED_DRIVER)/ed_driver.f90 grid_coms.o ed_state_vars.o ed_misc_coms.o        \
	soil_coms.o ed_node_coms.o consts_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

ed_filelist.o : $(ED_UTILS)/ed_filelist.F90 ed_max_dims.o
	cp -f $< $(<F:.F90=.F90)
	$(FPP_COMMAND) $(<F:.F90=.F90)
	rm -f $(<F:.F90=.F90) 

ed_grid.o : $(ED_UTILS)/ed_grid.f90 grid_coms.o ed_node_coms.o ed_max_dims.o consts_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 

ed_history_io.o : $(ED_IO)/ed_history_io.F90 ed_max_dims.o pft_coms.o ed_misc_coms.o       \
	mem_sites.o consts_coms.o ed_state_vars.o grid_coms.o soil_coms.o ed_node_coms.o   \
	hdf5_coms.o fusion_fission_coms.o ed_therm_lib.o allometry.o fuse_fiss_utils.o     \
	therm_lib.o
	cp -f $< $(<F:.F90=.F90)
...
ed_init.o : $(ED_INIT)/ed_init.f90 grid_coms.o ed_work_vars.o soil_coms.o ed_node_coms.o   \
	ed_state_vars.o phenology_coms.o phenology_init.o ed_misc_coms.o consts_coms.o     \
	rk4_coms.o canopy_air_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

ed_max_dims.o : $(ED_MEMORY)/ed_max_dims.F90 grid_dims.o
	cp -f $< $(<F:.F90=.F90)
	$(FPP_COMMAND) $(<F:.F90=.F90)
	rm -f $(<F:.F90=.F90)
...
ed_misc_coms.o : $(ED_MEMORY)/ed_misc_coms.f90 ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

ed_node_coms.o : $(ED_MPI)/ed_node_coms.f90 ed_max_dims.o 
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 

ed_opspec.o : $(ED_IO)/ed_opspec.F90 ed_max_dims.o grid_coms.o mem_sites.o soil_coms.o     \
	ed_para_coms.o ed_misc_coms.o consts_coms.o physiology_coms.o decomp_coms.o        \
	disturb_coms.o phenology_coms.o pft_coms.o rk4_coms.o
	cp -f $< $(<F:.F90=.F90)
	$(FPP_COMMAND) $(<F:.F90=.F90)
	rm -f $(<F:.F90=.F90)

ed_para_coms.o : $(ED_MPI)/ed_para_coms.f90 ed_max_dims.o 
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 

ed_params.o : $(ED_INIT)/ed_params.f90 ed_max_dims.o pft_coms.o disturb_coms.o             \
	ed_misc_coms.o met_driver_coms.o canopy_radiation_coms.o decomp_coms.o             \
	hydrology_coms.o soil_coms.o phenology_coms.o fusion_fission_coms.o allometry.o    \
	consts_coms.o rk4_coms.o canopy_air_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

ed_state_vars.o : $(ED_MEMORY)/ed_state_vars.f90 grid_coms.o ed_max_dims.o c34constants.o  \
	disturb_coms.o met_driver_coms.o fusion_fission_coms.o phenology_coms.o            \
	ed_misc_coms.o ed_var_tables.o ed_node_coms.o soil_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

ed_therm_lib.o : $(ED_UTILS)/ed_therm_lib.f90 consts_coms.o pft_coms.o ed_state_vars.o     \
	therm_lib.o canopy_radiation_coms.o rk4_coms.o allometry.o soil_coms.o grid_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

ed_type_init.o : $(ED_INIT)/ed_type_init.f90 ed_state_vars.o ed_max_dims.o grid_coms.o     \
	soil_coms.o therm_lib.o allometry.o consts_coms.o pft_coms.o ed_therm_lib.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
ed_xml_config.o : $(ED_IO)/ed_xml_config.f90 pft_coms.o hydrology_coms.o met_driver_coms.o \
	...
	decomp_coms.o fusion_fission_coms.o ed_misc_coms.o soil_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

edio.o : $(ED_IO)/edio.f90 ed_state_vars.o grid_coms.o ed_node_coms.o ed_misc_coms.o       \
	canopy_radiation_coms.o consts_coms.o ed_var_tables.o therm_lib.o soil_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

ename_coms.o : $(ED_MEMORY)/ename_coms.f90 ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

euler_driver.o : $(ED_DYNAMICS)/euler_driver.f90 ed_state_vars.o ed_misc_coms.o            \
	soil_coms.o consts_coms.o canopy_struct_dynamics.o grid_coms.o ed_max_dims.o       \
	therm_lib.o canopy_air_coms.o ed_therm_lib.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

events.o : $(ED_DYNAMICS)/events.f90 ed_misc_coms.o grid_coms.o ed_state_vars.o pft_coms.o \
...
fatal_error.o : $(ED_UTILS)/fatal_error.f90 ed_node_coms.o ed_misc_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
forestry.o : $(ED_DYNAMICS)/forestry.f90 ed_state_vars.o disturb_coms.o disturbance.o      \
	fuse_fiss_utils.o ed_max_dims.o grid_coms.o allometry.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
fuse_fiss_utils.o : $(ED_UTILS)/fuse_fiss_utils.f90 ed_state_vars.o pft_coms.o             \
	decomp_coms.o fusion_fission_coms.o disturb_coms.o ed_max_dims.o mem_sites.o       \
...
grid_coms.o : $(ED_MEMORY)/grid_coms.f90 ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
growth_balive.o : $(ED_DYNAMICS)/growth_balive.f90 ed_state_vars.o pft_coms.o allometry.o  \
	...
	ed_max_dims.o ed_misc_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

h5_output.o : $(ED_IO)/h5_output.F90 an_header.o ed_var_tables.o ed_misc_coms.o            \
	grid_coms.o hdf5_coms.o ed_node_coms.o ed_max_dims.o ed_state_vars.o               \
...
init_hydro_sites.o : $(ED_INIT)/init_hydro_sites.f90 soil_coms.o grid_coms.o               \
	ed_misc_coms.o mem_sites.o ed_state_vars.o ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90) 
	rm -f $(<F:.f90=.f90)

invmondays.o : $(ED_UTILS)/invmondays.f90 ed_misc_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

landuse_init.o : $(ED_INIT)/landuse_init.f90 ed_state_vars.o consts_coms.o disturb_coms.o  \
	ed_misc_coms.o grid_coms.o ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
lsm_hyd.o : $(ED_DYNAMICS)/lsm_hyd.f90 hydrology_constants.o grid_coms.o hydrology_coms.o  \
	ed_state_vars.o ed_node_coms.o soil_coms.o ed_misc_coms.o therm_lib.o              \
	consts_coms.o pft_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

mem_sites.o : $(ED_MEMORY)/mem_sites.f90 ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

met_driver_coms.o : $(ED_MEMORY)/met_driver_coms.f90 ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

mortality.o : $(ED_DYNAMICS)/mortality.f90 ed_state_vars.o pft_coms.o disturb_coms.o       \
	ed_misc_coms.o ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

optimiz_coms.o : $(ED_MEMORY)/optimiz_coms.f90 ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 

phenology_aux.o : $(ED_DYNAMICS)/phenology_aux.f90 phenology_coms.o ed_max_dims.o          \
	pft_coms.o ed_state_vars.o consts_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
phenology_driv.o : $(ED_DYNAMICS)/phenology_driv.f90 soil_coms.o pft_coms.o decomp_coms.o  \
	...
	allometry.o ed_misc_coms.o ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

phenology_init.o : $(ED_INIT)/phenology_init.f90 grid_coms.o phenology_coms.o              \
	ed_misc_coms.o ed_state_vars.o ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

photosyn_driv.o : $(ED_DYNAMICS)/photosyn_driv.f90 ed_state_vars.o ed_max_dims.o           \
	pft_coms.o grid_coms.o soil_coms.o consts_coms.o ed_misc_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

physiology_coms.o : $(ED_MEMORY)/physiology_coms.f90 ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

pft_coms.o : $(ED_MEMORY)/pft_coms.f90 ed_max_dims.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

radiate_driver.o : $(ED_DYNAMICS)/radiate_driver.f90 ed_misc_coms.o ed_state_vars.o        \
	canopy_radiation_coms.o consts_coms.o grid_coms.o soil_coms.o ed_max_dims.o        \
	rk4_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

reproduction.o : $(ED_DYNAMICS)/reproduction.f90 ed_state_vars.o ed_misc_coms.o pft_coms.o \
	decomp_coms.o fusion_fission_coms.o ed_max_dims.o fuse_fiss_utils.o allometry.o    \
	phenology_coms.o consts_coms.o canopy_air_coms.o mem_sites.o ed_therm_lib.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

rk4_coms.o : $(ED_MEMORY)/rk4_coms.f90 grid_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

rk4_derivs.o : $(ED_DYNAMICS)/rk4_derivs.F90 ed_state_vars.o consts_coms.o grid_coms.o     \
	ed_max_dims.o grid_coms.o soil_coms.o ed_misc_coms.o canopy_radiation_coms.o       \
	therm_lib.o pft_coms.o canopy_air_coms.o ed_therm_lib.o allometry.o rk4_coms.o     \
	canopy_struct_dynamics.o
	cp -f $< $(<F:.F90=.F90)
	$(FPP_COMMAND) $(<F:.F90=.F90)
	rm -f $(<F:.F90=.F90)

rk4_driver.o : $(ED_DYNAMICS)/rk4_driver.f90 ed_state_vars.o grid_coms.o ed_max_dims.o     \
	ed_misc_coms.o consts_coms.o soil_coms.o canopy_radiation_coms.o canopy_air_coms.o \
	therm_lib.o ed_therm_lib.o rk4_coms.o canopy_struct_dynamics.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
rk4_integ_utils.o : $(ED_DYNAMICS)/rk4_integ_utils.f90 ed_state_vars.o rk4_stepper.o       \
	...
	canopy_radiation_coms.o therm_lib.o ed_max_dims.o rk4_coms.o canopy_air_coms.o     \
	allometry.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
rk4_stepper.o : $(ED_DYNAMICS)/rk4_stepper.F90 ed_state_vars.o grid_coms.o soil_coms.o     \
	...
	ed_misc_coms.o rk4_coms.o therm_lib.o
	cp -f $< $(<F:.F90=.F90)
	$(FPP_COMMAND) $(<F:.F90=.F90)
	rm -f $(<F:.F90=.F90)

soil_coms.o : $(ED_MEMORY)/soil_coms.F90 ed_max_dims.o grid_coms.o leaf_coms.o
	cp -f $< $(<F:.F90=.F90)
	$(FPP_COMMAND) $(<F:.F90=.F90)
	rm -f $(<F:.F90=.F90)
...
structural_growth.o : $(ED_DYNAMICS)/structural_growth.f90 ed_state_vars.o pft_coms.o      \
	decomp_coms.o ed_max_dims.o consts_coms.o ed_therm_lib.o allometry.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
update_derived_props.o : $(ED_UTILS)/update_derived_props.f90 ed_state_vars.o allometry.o  \
	...
	grid_coms.o ed_therm_lib.o ed_misc_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
