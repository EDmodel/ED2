...
edcp_load_namelist.o : $(ED_MIXED)/edcp_load_namelist.f90 max_dims.o soil_coms.o           \
	...
	mem_grid.o io_params.o mem_leaf.o mem_radiate.o grid_dims.o rk4_coms.o             \
...
edcp_met.o : $(ED_MIXED)/edcp_met.f90 node_mod.o rconstants.o met_driver_coms.o            \
	...
	ed_work_vars.o mem_turb.o micphys.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
euler_driver.o : $(ED_DYNAMICS)/euler_driver.f90 ed_state_vars.o misc_coms.o soil_coms.o   \
	consts_coms.o canopy_struct_dynamics.o grid_coms.o max_dims.o therm_lib.o          \
...
photosyn_driv.o : $(ED_DYNAMICS)/photosyn_driv.f90 ed_state_vars.o max_dims.o pft_coms.o   \
	grid_coms.o soil_coms.o consts_coms.o misc_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
radiate_driver.o : $(ED_DYNAMICS)/radiate_driver.f90 misc_coms.o ed_state_vars.o           \
	...
	rk4_coms.o allometry.o pft_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F90_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
