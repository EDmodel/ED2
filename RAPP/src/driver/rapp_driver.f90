   ...
   case ('ncep')
      ...
      yearloop: do year=iyeara,iyearz
         ...
         monthloop: do month=1,12
            ...
            !------------------------------------------------------------------------------!
            ! 4. Load the data into the matrices.  In case the user does not have an year  !
            ...
            !------------------------------------------------------------------------------!
            ! 5. Interpolate the state variable data from lon/lat grid to Gaussian, and    !
            !    the fluxes to the more refined time scale.                                !
            !------------------------------------------------------------------------------!
            call interp_driver(month,year)
            ...
            !------------------------------------------------------------------------------!
            ! 7. Deallocate ncep structure before next month is called.                    a!
            !------------------------------------------------------------------------------!
            call dealloc_driver(.false.)
         end do monthloop
