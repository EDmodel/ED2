...
use consts_coms, only: ep,t00,rdry,alvl,cp,cpog,rocp,grav
implicit none
real :: p,t,rv,the
...
use consts_coms, only : cp, alvl,rocp,p00i
implicit none
real :: the,p,th,t,r
...
use consts_coms, only: cliqi,cicei,allii,alli,t00
implicit none
real, intent(in)  :: q
...
use consts_coms, only: cliqi,cliq,cicei,cice,allii,alli,t00
implicit none
