...
module phenology_driv
   ...
   !=======================================================================================!
   !=======================================================================================!
   !     This subroutine will make a simpler version of the leaf phenology:  it will       !
   ! change bleaf according to cold or drought, but it won't check whether there is enough !
   ! carbon to change it, it will simply change it to the target bleaf.                    !
   !---------------------------------------------------------------------------------------!
         ...
         cohortloop: do ico = 1,cpatch%ncohorts
            ...
            case (1)
               ...
               call assign_prescribed_phen(cpoly%green_leaf_factor(ipft,isi)               &
                                          ,cpoly%leaf_aging_factor(ipft,isi)               &
                                          ,cpatch%dbh(ico),cpatch%hite(ico),ipft           &
                                          ,drop_cold,leaf_out_cold,bleaf_new)
            case default
               !----- Drop_cold is computed in phenology_thresholds for Botta scheme. -----!
            ...
            case (0)
               !---------------------------------------------------------------------------!
               !    Evergreen, there is nothing to be done here, assign elongation factor  !
               ! to maximum and move on.                                                   !
               !---------------------------------------------------------------------------!
               cpatch%elongf(ico)    = 1.0
