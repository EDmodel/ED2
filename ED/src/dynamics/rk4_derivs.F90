...
!        intercepted = pcpg
  ...
  do ico = 1,cpatch%ncohorts
     ...
     if(cpatch%lai(ico) > lai_min)then
        ...
        !     the temperature is way off. It is okay for the temperature to be not too close
        !     to the equilibrium during the partial steps, but if it is way off, this means
        !     numerical instability, so we should not leave it there... 
