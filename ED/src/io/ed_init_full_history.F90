...
subroutine fill_history_patch(cpatch,paco_index,ncohorts_global,green_leaf_factor)
  ...
  if(cpatch%ncohorts>0) then
     ...
     call hdf_getslab_r(cpatch%veg_co2_open,'VEG_CO2_OPEN ',dsetrank,iparallel,.true.)
     call hdf_getslab_r(cpatch%veg_co2_closed,'VEG_CO2_CLOSED ',dsetrank,iparallel,.true.)
