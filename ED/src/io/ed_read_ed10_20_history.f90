                  ...
                  do ic = 1,ncohorts
                     ...
                     if (trim(csite%pname(ipa)) == trim(cpname(ic) ) .and.                 &
                        ...
                        case (6)
                           ...
                           cpatch%hite(ic2)  = dbh2h_simple(ipft(ic),dbh(ic))
                        ...
                        ! pools.                                                           !
                        !------------------------------------------------------------------!
                        cpatch%bleaf(ic2)     = size2bl_old(dbh(ic), hite(ic),ipft(ic))
                        ...
                        call area_indices_old(cpatch%nplant(ic2),cpatch%bleaf(ic2)         &
