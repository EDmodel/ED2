...
module rk4_coms
   ...
   type rk4patchtype
      ...
      real(kind=8), pointer, dimension(:) :: sapa_storage_resp ! Storage resp   [�mol/m�/s]
      real(kind=8), pointer, dimension(:) :: sapb_storage_resp ! Storage resp   [�mol/m�/s]
      real(kind=8), pointer, dimension(:) :: leaf_growth_resp !                 [�mol/m�/s]
      real(kind=8), pointer, dimension(:) :: root_growth_resp !                 [�mol/m�/s]
      real(kind=8), pointer, dimension(:) :: sapa_growth_resp !                 [�mol/m�/s]
      real(kind=8), pointer, dimension(:) :: sapb_growth_resp !                 [�mol/m�/s]
