...
subroutine ed_masterput_nl(par_run)
   ...
   call MPI_Bcast(mphoto_c3,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(d0_decay,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
...
!----- Now the namelist -------------------------------------------------------------------!
   ...
   call MPI_Bcast(mphoto_c3,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(d0_decay,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
