...
subroutine ed_masterput_nl(par_run)
   ...
   call MPI_Bcast(ixoutput,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(xfilout,str_len,MPI_CHARACTER,mainnum,MPI_COMM_WORLD,ierr)
...
!----- Now the namelist -------------------------------------------------------------------!
   ...
   call MPI_Bcast(ixoutput,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(xfilout,str_len,MPI_CHARACTER,master_num,MPI_COMM_WORLD,ierr)
