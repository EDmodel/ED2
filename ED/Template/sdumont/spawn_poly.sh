...
desc=$(basename ${here})
#----- Queue to which the current simulation array should be submitted. -------------------#
global_queue="cpu_long" 
#----- Original and scratch main data paths. ----------------------------------------------#
d_original=${HOME}/Data
d_scratch=${SCRATCH}/Data
#----- Path with modules. -----------------------------------------------------------------#
...
#----- Synchronise data on scratch. -------------------------------------------------------#
#mkdir -p ${d_scratch}
#rsync -Prutv ${d_original}/* ${d_scratch}
#------------------------------------------------------------------------------------------#
...
echo "#SBATCH --output=${here}/out_batch.out  # Standard output path"          >> ${sbatch}
echo "#SBATCH --error=${here}/out_batch.err   # Standard error path"           >> ${sbatch}
echo ""                                                                        >> ${sbatch}
