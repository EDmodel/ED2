...
do
   ...
   icarbonmort=$(echo ${oi}  | awk '{print $95 }')
   ihydromort=$(echo ${oi}   | awk '{print $96 }')
   igndvap=$(echo ${oi}      | awk '{print $97 }')
   iphen=$(echo ${oi}        | awk '{print $98 }')
   iallom=$(echo ${oi}       | awk '{print $99 }')
   ieconomics=$(echo ${oi}   | awk '{print $100}')
   igrass=$(echo ${oi}       | awk '{print $101}')
   ibigleaf=$(echo ${oi}     | awk '{print $102}')
   integscheme=$(echo ${oi}  | awk '{print $103}')
   nsubeuler=$(echo ${oi}    | awk '{print $104}')
   irepro=$(echo ${oi}       | awk '{print $105}')
   treefall=$(echo ${oi}     | awk '{print $106}')
   ianthdisturb=$(echo ${oi} | awk '{print $107}')
   ianthdataset=$(echo ${oi} | awk '{print $108}')
   slscale=$(echo ${oi}      | awk '{print $109}')
   slyrfirst=$(echo ${oi}    | awk '{print $110}')
   slnyrs=$(echo ${oi}       | awk '{print $111}')
   bioharv=$(echo ${oi}      | awk '{print $112}')
   skidarea=$(echo ${oi}     | awk '{print $113}')
   skidsmall=$(echo ${oi}    | awk '{print $114}')
   skidlarge=$(echo ${oi}    | awk '{print $115}')
   fellingsmall=$(echo ${oi} | awk '{print $116}')
   #---------------------------------------------------------------------------------------#
