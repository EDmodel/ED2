...
ed_1st.o : $(ED_DRIVER)/ed_1st.f90 ed_state_vars.o mem_sites.o \
	ed_para_coms.o misc_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
ed_driver.o : $(ED_DRIVER)/ed_driver.f90  grid_coms.o ed_state_vars.o \
	ed_node_coms.o soil_coms.o misc_coms.o consts_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
ed_init_atm.o : $(ED_INIT)/ed_init_atm.f90 misc_coms.o   \
...
ed_load_namelist.o : $(ED_IO)/ed_load_namelist.f90 max_dims.o \
...
ed_mem_alloc.o : $(ED_MEMORY)/ed_mem_alloc.f90 \
	ed_node_coms.o ed_mem_grid_dim_defs.o max_dims.o \
	grid_coms.o soil_coms.o mem_sites.o ed_work_vars.o misc_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
ed_met_driver.o : $(ED_DRIVER)/ed_met_driver.f90  grid_coms.o \
...
ed_model.o : $(ED_DRIVER)/ed_model.f90 misc_coms.o grid_coms.o ed_state_vars.o \
	rk4_driver.o ed_node_coms.o disturb_coms.o mem_sites.o disturbance.o \
	fuse_fiss_utils.o growth_balive.o consts_coms.o max_dims.o pft_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)

ed_mpass_init.o : $(ED_MPI)/ed_mpass_init.f90 decomp_coms.o disturb_coms.o \
	ed_state_vars.o ed_work_vars.o grid_coms.o max_dims.o mem_sites.o \
	met_driver_coms.o misc_coms.o ed_node_coms.o optimiz_coms.o phenology_coms.o \
	physiology_coms.o pft_coms.o ed_para_coms.o soil_coms.o met_driver_coms.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
ed_params.o : $(ED_INIT)/ed_params.f90 max_dims.o pft_coms.o disturb_coms.o \
	...
	phenology_coms.o fusion_fission_coms.o 
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
