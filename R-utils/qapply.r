...
qapply <<- function(X,INDEX,DIM,FUN,...){
   ...
   #---------------------------------------------------------------------------------------#
   #     Find out whether X is a data frame. If so, we return the same variable types and  #
   # names.                                                                                #
   #---------------------------------------------------------------------------------------#
   X.df = is.data.frame(X)
   if (missing(DIM) && X.df) DIM = 1
   #---------------------------------------------------------------------------------------#
   ...
   #---------------------------------------------------------------------------------------#
   #    If the original data was a data frame and DIM was 1 (or missing), make sure the    #
   # output is also a data frame.                                                          #
   #---------------------------------------------------------------------------------------#
   if (X.df && (DIM == 1)){
