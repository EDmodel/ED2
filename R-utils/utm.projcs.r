...
#==========================================================================================#
#==========================================================================================#
#     This function generates the projection table for regular longitude-latitude grids.   #
#------------------------------------------------------------------------------------------#
longlat.projcs <<- function(){

   #----- Datum block. --------------------------------------------------------------------#
   datlab   = "\"D_WGS_1984\""
   spheroid = "SPHEROID[\"WGS_1984\",6378137,298.257223563]"
   datum    = paste0("DATUM[",datlab,",",spheroid,"]")
   #---------------------------------------------------------------------------------------#
   ...
   #------ Build the string ready to write to the projection file. ------------------------#
   projcs = paste0("GEOGCS[",gcslab,",",datum,",",primem,",",unit,"]")
   return(projcs)
   #---------------------------------------------------------------------------------------#
}#end function
#==========================================================================================#
