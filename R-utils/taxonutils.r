...
standard.scientific.name <<- function(dat){
   ...
   g.s = sub("Anomalocalyx uleanus"       ,"Dodecastigma uleanum"         ,x=g.s)
   ...
   g.s = sub("Astronium gracile"          ,"Astronium graveolens"         ,x=g.s)
   ...
   g.s = sub("Brosmium acutifolium"       ,"Brosimum acutifolium"         ,x=g.s)
   ...
   g.s = sub("Irynthera juruensis"        ,"Iryanthera juruensis"         ,x=g.s)
   ...
   g.s = sub("Maytenus floribunda"        ,"Maytenus pittieriana"         ,x=g.s)
   ...
   g.s = sub("Muiriri brevipes"           ,"Mouriri brevipes"             ,x=g.s)
   g.s = sub("Myrciaria reticulata"       ,"Myrcia reticulata"            ,x=g.s)
   g.s = sub("Myrcia fallax"              ,"Myrcia splendens"             ,x=g.s)
   ...
   g.s = sub("Protium paraense"           ,"Protium altsonii"             ,x=g.s)
   g.s = sub("Protium paraensis"          ,"Protium altsonii"             ,x=g.s)
   ...
   g.s = sub("Ruizterania albiflora"      ,"Qualea albiflora"             ,x=g.s)
   ...
   g.s = sub("Sloanea excelsa"            ,"Sloanea laurifolia"           ,x=g.s)
   ...
   g.s = sub("Visma guianensis"           ,"Vismia guianensis"            ,x=g.s)
...
standard.family.name <<- function(datum){
   ...
   n=n+1; g2f[[n]] = list( genus = "Apodytes"          , family = "Metteniusaceae"   )
   ...
   n=n+1; g2f[[n]] = list( genus = "Dendrobangia"      , family = "Metteniusaceae"   )
   ...
   n=n+1; g2f[[n]] = list( genus = "Emmotum"           , family = "Metteniusaceae"   )
   ...
   n=n+1; g2f[[n]] = list( genus = "Poraqueiba"        , family = "Metteniusaceae"   )
   ...
   n=n+1; f2nog[[n]] = list(family = "Metteniusaceae"   , genus = "Ignotum.metteniusa"    )
